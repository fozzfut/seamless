...
| [008](issues/008-fillet-rim-ending-on-a-face) | Скругление кромки выреза, обрывающейся о грань, отказывает при r ≥ 0.25; замкнутая кромка скругляется | не определено, вероятно OCCT | измерено |
