...
BIN="${SEAMLESS_BIN:-/c/dev/seamless/build/occt-release/win64/vc14/bin}"
export CASROOT="C:/dev/seamless/occt"
export CSF_OCCTResourcePath="C:/dev/seamless/occt/src"
export CSF_OCCTDataPath="C:/dev/seamless/occt/data"
export CSF_TestDataPath="C:/dev/seamless/occt/data"
# both the stock OCCT groups and the generated "seamless" group
export CSF_TestScriptsPath="C:/dev/seamless/occt/tests;$SP/tests"
