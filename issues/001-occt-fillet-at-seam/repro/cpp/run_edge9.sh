...
#
# Example:
#   bash repro/cpp/run_edge9.sh C:/dev/freecad-kernel-fixes/build/kernel-e9-stock stock 300
#   bash repro/cpp/run_edge9.sh C:/dev/freecad-kernel-fixes/build/kernel-e9-fix   patched 300

set -u

EXE="${EXE:-C:/dev/freecad-kernel-fixes/build/edge9/edge9_fillet.exe}"
...
DEADLINE="${3:-300}"
LOGDIR="${LOGDIR:-C:/dev/freecad-kernel-fixes/build/edge9/logs-$LABEL}"
