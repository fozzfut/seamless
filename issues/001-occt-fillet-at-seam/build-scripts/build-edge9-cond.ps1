...
# C:/dev/freecad-kernel-fixes/build/occt-cond (see configure-occt-cond.ps1 for why it is private).
#
...
$SDKVER = '10.0.22000.0'
$OCCT   = 'C:\dev\freecad-kernel-fixes\build\occt-cond'
$SRC    = 'C:\dev\freecad-kernel-fixes\repro\cpp\edge9_fillet.cpp'
$OUTDIR = 'C:\dev\freecad-kernel-fixes\build\edge9-cond'
