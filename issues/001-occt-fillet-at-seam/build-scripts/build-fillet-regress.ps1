...
$SDKVER = '10.0.22000.0'
$OCCT   = 'C:\dev\freecad-kernel-fixes\build\occt-fix'
$OCCTR  = 'C:\dev\freecad-kernel-fixes\build\occt-release'
$SRC    = 'C:\dev\freecad-kernel-fixes\repro\cpp\fillet_regress.cpp'
$OUTDIR = 'C:\dev\freecad-kernel-fixes\build\regress'
