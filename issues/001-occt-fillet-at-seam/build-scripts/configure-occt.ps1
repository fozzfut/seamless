...
# Сборка ВНЕ исходников: исходники C:/dev/freecad-kernel-fixes/occt не изменяются.
# Запуск:  powershell -ExecutionPolicy Bypass -File C:\dev\freecad-kernel-fixes\build-scripts\configure-occt.ps1
...
$BuildDir  = 'C:/dev/freecad-kernel-fixes/build/occt-release'
$InstallDir= 'C:/dev/freecad-kernel-fixes/install/occt-7.8.1'
