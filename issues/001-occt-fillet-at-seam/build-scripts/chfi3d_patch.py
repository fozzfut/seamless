...
The shared clone at C:/dev/freecad-kernel-fixes/occt is being edited by another agent team at the
...
BACKUP = os.environ.get("OCCT_SRC_BACKUP", r"C:\dev\freecad-kernel-fixes\build\occt-src-orig")
