...
# reproduction program against the SELF-CONTAINED install at C:\dev\freecad-kernel-fixes\install\occt-fix
...
$SDKVER = '10.0.22000.0'
$KERNEL = 'C:\dev\freecad-kernel-fixes\install\occt-fix'
$SRC    = 'C:\dev\freecad-kernel-fixes\repro\cpp\seam_fillet.cpp'
$OUTDIR = 'C:\dev\freecad-kernel-fixes\build\verify-fixed'
