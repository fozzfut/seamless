...
#   C:/dev/freecad-kernel-fixes/occt  - shared clone, src/ChFi3d edited (git status: 2 modified files)
...
#   cd C:/dev/freecad-kernel-fixes/occt && git archive V7_8_1 | tar -x -C C:/dev/occt-cond
...
$InstallDir= 'C:/dev/freecad-kernel-fixes/install/occt-cond'
