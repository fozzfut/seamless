...
# ---------------------------
# The shared clone C:/dev/freecad-kernel-fixes/occt is written by more than one agent team. During
...
# C:/dev/occt-fix (sources) and C:/dev/freecad-kernel-fixes/build/occt-fix (build tree), and the
...
SHARED="${SHARED_OCCT:-C:/dev/freecad-kernel-fixes/occt}"
SRC="${OCCT_FIX_SRC:-C:/dev/occt-fix}"
BLD="${OCCT_FIX_BUILD:-C:/dev/freecad-kernel-fixes/build/occt-fix}"
INST="${OCCT_FIX_INSTALL:-C:/dev/freecad-kernel-fixes/install/occt-fix}"
ORIG="C:/dev/freecad-kernel-fixes/build/occt-src-orig"
RELEASE="C:/dev/freecad-kernel-fixes/build/occt-release"
