...
# built out of source in C:/dev/freecad-kernel-fixes/build/occt-release, then runs it.
#
...
$SRC     = 'C:\dev\freecad-kernel-fixes\repro\kernel-smoke\kernel_smoke.cpp'
$OUTDIR  = 'C:\dev\freecad-kernel-fixes\build\kernel-smoke'
