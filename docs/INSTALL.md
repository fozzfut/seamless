...
```powershell
& "C:\Program Files\FreeCAD 1.1\bin\FreeCADCmd.exe" C:\dev\seamless\build-scripts\verify-seam-fillet.py
Get-Content C:\dev\seamless\build-scripts\verify-seam-fillet.txt
```
