...
# C:/dev/seamless/build/occt-cond (see configure-occt-cond.ps1 for why it is private).
#
...
$SDKVER = '10.0.22000.0'
$OCCT   = 'C:\dev\seamless\build\occt-cond'
$SRC    = 'C:\dev\seamless\repro\cpp\edge9_fillet.cpp'
$OUTDIR = 'C:\dev\seamless\build\edge9-cond'
