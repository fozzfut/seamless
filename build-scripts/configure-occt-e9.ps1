...
#   C:/dev/seamless/occt      - shared clone, its src/ChFi3d is edited by another agent team
...
$BuildDir  = 'C:/dev/seamless/build/occt-e9'
$InstallDir= 'C:/dev/seamless/install/occt-e9'
