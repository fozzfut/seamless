// kernel_smoke.cpp
//
// Proof that the OCCT kernel built locally from C:/dev/seamless/occt (tag V7_8_1)
...
int main(int argc, char** argv)
{
  ...
  printf("built from C:/dev/seamless/occt, linked against "
         "C:/dev/seamless/build/occt-release/win64/vc14/lib\n\n");
