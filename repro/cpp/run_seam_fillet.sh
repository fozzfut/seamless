...
EXE="${EXE:-C:/dev/seamless/build/seam-fillet/seam_fillet.exe}"
OCCT_BIN="${OCCT_BIN:-C:/dev/seamless/build/occt-release/win64/vc14/bin}"
LOGDIR="${LOGDIR:-C:/dev/seamless/build/seam-fillet/logs}"
DEADLINE="${1:-600}"
